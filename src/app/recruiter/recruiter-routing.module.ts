...
const routes: Routes = [
  ...
  {path:"advanceSearchr",component:SearchprofilesComponent},
...
{path:'Recruitment/SendingEmail',component:EmailComponent},
{path:'Recruitment/SendSMS',component:SMSComponent},
{path:'recruitment/searchProfiles',component:ModifysearchComponent}
];
